/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4c9d7742baa23d8199d0446ff8009dd9)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	TRELLIS_BUCKET: R2Bucket;
	NEON_POOLED_CONNECTION_STRING: string;
	VITE_AUTH_BASE_URL: string;
	AUTH_SECRET: string;
	TRELLIS_FILE_UPLOADER: Workflow /* TrellisFileUploader */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEON_POOLED_CONNECTION_STRING" | "VITE_AUTH_BASE_URL" | "AUTH_SECRET">> {}
}
